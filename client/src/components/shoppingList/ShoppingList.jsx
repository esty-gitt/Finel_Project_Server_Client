...
const ShoppingList = () => {
   const {id} = useParams();
    ...
    const { data:lists } = useGetShoppingListQuery(undefined, {
        selectFromResult: ({ data }) => ({
          data: data?.find(list => list._id === id)
        })
      });
     ...
     <div>name
         ...
         <div className="card" style={{ width: '70%',margin: '0 auto' }}>
                ...
                <DataTable ref={dt} value={products} selection={selectedProducts} onSelectionChange={(e) => setSelectedProducts(e.value)}
                    ...
                    <Column field="quantity" header="Quntity" sortable style={{ minWidth: '16rem' }}></Column>

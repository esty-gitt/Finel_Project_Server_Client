...
import {useAddSoppingListMutation,useDeleteShoppingListMutation,useGetShoppingListQuery} from '../../slices/shoppingList/shoppingListApiSlice';
...
const MenuSide = () => {
    ...
    const [addShppingList, { data: addedShoppingLis, isSuccess: isSuccessAddList }] = useAddSoppingListMutation();

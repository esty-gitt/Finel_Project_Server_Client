...
const [password, setPassword] = useState('');
    ...
    const saveProduct = async() => {
        ...
        try {
         ...
         setProductDialog(false);
           setPassword('');
            refetch(); // רענון הרשימה לאחר הוספת משתמש חדש
            setProduct(emptyProduct);
           // רענון הרשימה לאחר הוספת משתמש חדש
        } catch (err) {
...
try {
    const _id = product._id;
       ...
       await deleteUser(_id).unwrap(); // Use unwrap to handle the promise and catch errors
       refetch()
       setDeleteProductDialog(false);
      setProduct(emptyProduct);
